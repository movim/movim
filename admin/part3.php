<div id="main">
    ...
    <div id="center">
        ...
        <div style="margin: 20px;">
            ...
            <br />
            <p>
                <?php echo t("You can also install your own BOSH server, to do this follow the documentation %s!", '<a href="http://wiki.movim.eu/manual:bosh_servers?s[]=bosh">http://wiki.movim.eu/manual:bosh_servers?s[]=bosh</a>'); ?> 
            </p>
            <br />
                ...
                <fieldset>
                    <legend><?php echo $steps[$display]; ?></legend><br />
                        ...
                        <!--<div class="element" <?php //echo generate_Tooltip(t("If you have to connect to the BOSH server with a Proxy fill this form with a proxy URL in the form http://hostname:port otherwise leave blank. <br> If unsure leave blank")); ?>>
                            ...
                            <input type="text" id="boshProxy" name="boshProxy" value="<?php echo get_preset_value('boshProxy', ''); ?> " size="40"/>
                        </div>-->
                </fieldset>
