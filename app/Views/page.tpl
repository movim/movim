...
<html translate="no" lang="<%language%>">
    <head>
        ...
        <meta name="theme-color" media="(prefers-color-scheme: light)" content="<?php if (!$this->public && $this->user && $this->user->nightmode) { ?>rgb(25, 32, 40)<?php } else { ?>rgb(238, 238, 238)<?php } ?>" />
