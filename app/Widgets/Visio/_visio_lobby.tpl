...
<div>
    {if="isset($contact)"}
        {if="$calling"}
            ...
            <button id="lobby_start" onclick="Visio.prepare('{$contact->id}', null, {if="$withvideo"}true{else}false{/if}); Dialog_ajaxClear();" class="button color green disabled">
                {if="$withvideo"}
        ...
        {else}
            ...
            <button id="lobby_start" onclick="Visio.prepare('{$contact->id}', '{$id}', {if="$withvideo"}true{else}false{/if}); Dialog_ajaxClear();" class="button color green disabled">
                {if="$withvideo"}
                    <i class="material-symbols">videocam</i>
                {else}
                    <i class="material-symbols">call</i>
