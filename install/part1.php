...
<div id="center" style="padding: 20px;" >
	<h1 style="padding: 0px;"><?php echo $title; ?></h1>
	<br>
		<form method="post" style="padding-right: 20px;" action="index.php">
			<fieldset>
				<legend><?php echo $steps[$display]; ?></legend>
                    <input type="hidden" name="step" value="1" />

					<div class="element large" <?php echo generate_Tooltip("So far there is only one theme. :-)"); ?>>
					...
					<div class="element large" <?php echo generate_Tooltip(t("Movim is already tranlsated in a lot of languages. <br>Some translations are unfortunately incomplete you could help translating on launchpad")); ?>>
					...
					<div class="element large" <?php echo generate_Tooltip(t("Movim can limit the maximum allowed amounts of registered users. If you do not want this feature leave the value \'-1\'.")); ?>>
					...
					<div class="element large" <?php echo generate_Tooltip(t("Set the logging options.")); ?>>
						<?php
							$logopts = array(
							0 => t('empty'),
							2 => t('terse'),
